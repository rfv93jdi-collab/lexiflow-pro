...
Уточните у автора ВКР / правообладателя. При отсутствии файла `LICENSE` код считается предоставленным «как есть» для учебных целей.

## Контакты и документация ВКР

Проект выполняется в рамках выпускной квалификационной работы; актуальные ссылки на сопроводительные материалы добавьте в этот раздел при публикации.
